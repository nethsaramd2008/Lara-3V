...
module.exports = {
SESSION_ID: process.env.SESSION_ID || "GZAUhDoT#VCtulFFOaXZ60Y6E1XPjm7KLgCUzyCbtyD6ND1u4Ph0", // Add your session id
PREFIX: process.env.PREFIX || ".",
MODE: process.env.MODE || "private",  //public | private | inbox | group
OWNER_NUMBER: process.env.OWNER_NUMBER || "94777585445",
DEV: process.env.DEV || "94777585445",
